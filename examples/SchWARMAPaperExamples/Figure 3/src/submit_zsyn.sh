...
cp SurfaceZSyndrome.py $savedir"/"

echo "python \"SurfaceZSyndrome.py $i $j $savedir\" -logfile "$savedir"logfile_"$i"_"$j".out"
python SurfaceZSyndrome.py $i $j $savedir -logfile $savedir"logfile_"$i"_"$j".out" 1> $savedir"surface_zsyn_"$i"_"$j".stdout" 2> $savedir"surface_xsyn_"$i"_"$j".stderr"  
