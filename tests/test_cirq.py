...
class TestCirq(unittest.TestCase):
    ...
    def test_single_qubit_control(self):
        ...
        sim = msim.CirqSchWARMASim(circ,S).dm_sim(1)
        sim = msim.CirqSchWARMASim(circ,S).dm_sim(3)
    ...
    def test_SequentialSchWARMAFier(self):
        ...
        S1 = msim.SingleQubitControlSchWARMAFier([.1],[1],[cirq.ops.common_gates.ZPowGate, cirq.ops.pauli_gates._PauliZ],cirq_gate_multiplicative)
        Ss = [msim.GateQubitDependentSchWARMAFier([.1],[1], cirq.ops.common_gates.CXPowGate, qq, error_gen=cirq_gate_multiplicative, sym=sym) for sym, qq in zip(['a','b','c','d'],[(q0,q1),(q1,q2),(q2,q1),(q1,q0)])]
